...
class Paddle(pygame.sprite.Sprite):
    def __init__(self, groups):
        ...
        pygame.draw.rect(self.shadow_surface, COLORS['paddle shadow'], pygame.FRect((0,0), SIZE['paddle']), 0, 4)
...
class Ball(pygame.sprite.Sprite):
    def __init__(self, groups, paddle_sprites, update_score):
        ...
        # shadow surface
        self.shadow_surface = self.image.copy()
        pygame.draw.circle(self.shadow_surface, COLORS['ball shadow'], (SIZE['ball'][0] / 2, SIZE['ball'][1] / 2), SIZE['ball'][1] / 2)
